...
.search-input { padding: 0.7rem 0.75rem 0.7rem 1.9rem; background: var(--bg-elevated); border: 1px solid rgba(255,255,255,0.12); border-radius: 4px; color: var(--text-primary); font-size: 0.9rem; font-family: inherit; outline: none; width: 100%; transition: border-color 0.15s; }
...
.modal-close { display: flex; align-items: center; justify-content: center; width: 36px; height: 36px; background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.13); border-radius: 4px; color: var(--text-muted); cursor: pointer; flex-shrink: 0; transition: background 0.15s, color 0.15s; }
...
.fi-select { width: 100%; padding: 0.8rem 2.5rem 0.8rem 1rem; background: var(--bg-elevated); border: 1px solid rgba(255,255,255,0.13); border-radius: 6px; color: var(--text-primary); font-size: 0.95rem; cursor: pointer; appearance: none; outline: none; min-height: 50px; }
...
.qty-control { display: flex; align-items: center; border: 1px solid rgba(255,255,255,0.13); border-radius: 6px; overflow: hidden; }
...
.fi-input { padding: 0.8rem 1rem; background: var(--bg-elevated); border: 1px solid rgba(255,255,255,0.13); border-radius: 6px; color: var(--text-primary); font-size: 1rem; outline: none; font-family: 'JetBrains Mono', monospace; transition: border-color 0.15s; }
...
.resumen-line { display: flex; align-items: center; justify-content: space-between; gap: 1rem; padding: 0.65rem 0; border-bottom: 1px solid rgba(255,255,255,0.04); }
